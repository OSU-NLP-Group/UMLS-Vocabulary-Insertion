...
do
    data='models/uva_ins_'$version'_max_len_64_num_cands_50_train_size_all_sorted_cuis/top50_candidates/'
    output='models/uva_ins_'$version'_max_len_64_num_cands_50_train_size_all_sorted_cuis'
